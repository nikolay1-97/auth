...
describe('AppAdminController (e2e)', () => {
    ...
    it('/app-admins/register (POST)', async() => {
        ...
        return request(app.getHttpServer()).post('/app-admins/register')
        .send({
    ...
    it('/app-admins/register (POST)', async() => {
        ...
        .expect(400).expect(
            { message: 'appAdmin already exists', error: 'Bad Request', statusCode: 400 }
        )
    }),
    it('/app-admins/login (POST)', async() => {

        return request(app.getHttpServer()).post('/app-admins/login')
        .send({
